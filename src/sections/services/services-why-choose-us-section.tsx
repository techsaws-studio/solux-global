...
import { ServicesWhyChooseUsSectionData } from "@/data/containers.services-page-data";

import ServicesWhyChooseUsSectionImg from "../../../public/images/services-why-choose-us-section-img.png";

function ServicesWhyChooseUsSection() {
  return (
      ...
      <div className="layout-standard section-padding-standard max-md:mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            {ServicesWhyChooseUsSectionData.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-background rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-border"
                >
          ...
          >
            <Image
              src={ServicesWhyChooseUsSectionImg}
              alt="Why Choose Us"
              fill
            />
          </motion.div>
...
export default ServicesWhyChooseUsSection;
