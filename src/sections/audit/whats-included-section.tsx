...
import { WhatsIncludedSectionData } from "@/data/containers.free-audit-page-data";
  ...
  return (
    <section className="bg-background section-padding-standard max-md:pt-4">
      ...
      >
        ...
        <motion.div
          variants={containerVariants}
          className="md:gap-4 gap-6 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1"
        >
          {WhatsIncludedSectionData.map((value, index) => {
